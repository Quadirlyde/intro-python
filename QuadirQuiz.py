...
A: there is a mistake in the source code
...
A: a function Definition names the function, a function call actually performs specified actions 
...
A: returns imformation about the data and stores data elements 